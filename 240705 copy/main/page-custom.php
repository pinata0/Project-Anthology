...
<div class="container">
    <div class="section section0" tabindex="0">
        <img src="<?php echo get_template_directory_uri(); ?>/images/black.jpeg" alt="Image 0">
        <span></span>
        <div class="box">
            <h1>엔솔로지</h1>
    ...
    <div class="section section1" tabindex="0" data-url="../c/1/game_index.html">
        <img src="<?php echo get_template_directory_uri(); ?>/images/main_1st.jpg" alt="Image 1">
        <span>게임</span>
        <div class="box">
            <h1>게임</h1>
    ...
    <div class="section section2" tabindex="0" data-url="../c/2/info_index.html">
        <img src="<?php echo get_template_directory_uri(); ?>/images/main_2nd.jpg" alt="Image 2">
        <span>정보</span>
        <div class="box">
            <h1>정보</h1>
    ...
    <div class="section section3" tabindex="0" data-url="../c/3/novel_index.html">
        <img src="<?php echo get_template_directory_uri(); ?>/images/main_3th.jpg" alt="Image 3">
        <span>소설</span>
        <div class="box">
            <h1>소설</h1>
    ...
    <div class="section section4" tabindex="0" data-url="../c/4/game_index.html">
        <img src="<?php echo get_template_directory_uri(); ?>/images/main_4th.jpg" alt="Image 4">
        <span>만화</span>
        <div class="box">
            <h1>만화</h1>
    ...
    <div class="section section5" tabindex="0" data-url="../c/5/game_index.html">
        <img src="<?php echo get_template_directory_uri(); ?>/images/main_5th.jpg" alt="Image 5">
        <span>그림</span>
        <div class="box">
            <h1>그림</h1>
    ...
    <div class="section section6" tabindex="0" data-url="../c/6/game_index.html">
        <img src="<?php echo get_template_directory_uri(); ?>/images/main_6th.jpg" alt="Image 6">
        <span>노래</span>
        <div class="box">
            <h1>음악</h1>
    ...
    <div class="section section7" tabindex="0" data-url="../c/7/game_index.html">
        <img src="<?php echo get_template_directory_uri(); ?>/images/main_7th.jpg" alt="Image 7">
        <span>커뮤니티</span>
        <div class="box">
            <h1>커뮤니티</h1>
    ...
    <div class="section section8" tabindex="0" data-url="../c/8/game_index.html">
        <img src="<?php echo get_template_directory_uri(); ?>/images/main_8th.jpg" alt="Image 8">
        <span>셀럽</span>
        <div class="box">
            <h1>셀럽</h1>
    ...
    <div class="section section9" tabindex="0" data-url="../c/9/game_index.html">
        <img src="<?php echo get_template_directory_uri(); ?>/images/main_9th.jpg" alt="Image 9">
        <span>밈</span>
        <div class="box">
            <h1>밈</h1>
